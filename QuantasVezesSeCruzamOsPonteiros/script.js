...
function initClock() {
	...
	for (let i = 0; i < 60; i++) {
		...
		if (i % 5 == 0) {
			if (i == 0)
				ctx.fillText(12, x - 16 + 1.1 * r * Math.cos(2 * Math.PI * i / 60 - Math.PI / 2), y + 10 + 1.1 * r * Math.sin(2 * Math.PI * i / 60 - Math.PI / 2));
			else if (i > 45)
				ctx.fillText(i / 5, x - 16 + 1.1 * r * Math.cos(2 * Math.PI * i / 60 - Math.PI / 2), y + 10 + 1.1 * r * Math.sin(2 * Math.PI * i / 60 - Math.PI / 2));
			else
				ctx.fillText(i / 5, x - 8 + 1.1 * r * Math.cos(2 * Math.PI * i / 60 - Math.PI / 2), y + 10 + 1.1 * r * Math.sin(2 * Math.PI * i / 60 - Math.PI / 2));
